...
1.  **The Process Framework (`AGENT_PROCESS_FRAMEWORK.md`)**
...
2.  **The Agent Strategy (`gemini-enabled-agent-supervisor.md`)**
...
```
Your core operating procedure is defined in @AGENT_PROCESS_FRAMEWORK.md.

For the current task, you will use the agent orchestration strategy defined in @gemini-enabled-agent-supervisor.md.
