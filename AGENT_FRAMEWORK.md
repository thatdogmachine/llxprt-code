...
- Timestamps must use proper ISO 8601 format: YYYY-MM-DDTHH:mm:ssZ
- Timestamps are updated AFTER task completion, not before
- Replace {{timestamp}} placeholder with actual timestamp when updating progress
